...
All 45 tests run against the real `auth_modern.log` — no mocks, no fixtures. Known facts (IP `218.75.153.170` is top attacker, `173.192.158.3` had 748 events in 4 min 39 sec) serve as regression anchors.
